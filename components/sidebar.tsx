...
export function Sidebar() {
  ...
  const links = access === "team" ? teamLinks : access === "finance_readonly" ? financeReadOnlyLinks : adminLinks;
  const displayName = email === "hi.growthive@gmail.com" ? "Gaby" : email === "margareth13105@gmail.com" ? "Xiu" : email === "riko.yf@gmail.com" ? "Riko" : email ? email.split("@")[0].replace(/[._]/g, " ") : "GrowthHive Team";
  const initials = email === "hi.growthive@gmail.com" ? "GB" : email === "margareth13105@gmail.com" ? "XI" : email === "riko.yf@gmail.com" ? "RK" : email ? email.slice(0, 2).toUpperCase() : "GH";

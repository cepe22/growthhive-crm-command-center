...
export function Sidebar() {
  ...
  const displayName = email === "hi.growthive@gmail.com" ? "Gaby" : email ? email.split("@")[0].replace(/[._]/g, " ") : "GrowthHive Team";
  const initials = email === "hi.growthive@gmail.com" ? "GB" : email ? email.slice(0, 2).toUpperCase() : "GH";

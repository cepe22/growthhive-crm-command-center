"use client";
import { BarChart3, BriefcaseBusiness, ChevronDown, CreditCard, LayoutDashboard, LogOut, ReceiptText, Settings, UsersRound, WalletCards } from "lucide-react";
...
export function Sidebar() {
  ...
  const displayName = email ? email.split("@")[0].replace(/[._]/g, " ") : "GrowthHive Team";
  const initials = email ? email.slice(0, 2).toUpperCase() : "GH";
